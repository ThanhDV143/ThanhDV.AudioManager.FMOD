...
- Click **Load All Buses** to:
    - Load all buses from the FMOD project without saving the changes.
...
- Click **Load All EventReferences** to:
    - Load all EventReferences from the FMOD project without saving the changes.
